# Bootstrappable Bytz Core Builds

This directory contains the files necessary to perform bootstrappable Bytz
Core builds.
...
To build Bytz Core reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/bytz-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/bytz-core/guix.sigs).
