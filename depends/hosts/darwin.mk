...
#
darwin_CC=clang -target $(host) -mmacosx-version-min=$(OSX_MIN_VERSION) --sysroot $(OSX_SDK) -mlinker-version=$(LD64_VERSION) -isysroot$(OSX_SDK) -isystem$(clang_resource_dir)/include -isystem$(OSX_SDK)/usr/include
darwin_CXX=clang++ -target $(host) -mmacosx-version-min=$(OSX_MIN_VERSION) --sysroot $(OSX_SDK) -mlinker-version=$(LD64_VERSION) -stdlib=libc++  -isysroot$(OSX_SDK) -isystem$(clang_resource_dir)/include -isystem$(OSX_SDK)/usr/include 
