...
$(package)_config_opts_arm_linux += -platform linux-g++ -xplatform bytz-linux-g++
$(package)_config_opts_i686_linux  = -xplatform linux-g++-32
$(package)_config_opts_x86_64_linux = -xplatform linux-g++-64
$(package)_config_opts_aarch64_linux = -xplatform linux-aarch64-gnu-g++
$(package)_config_opts_powerpc64_linux = -platform linux-g++ -xplatform bytz-linux-g++
$(package)_config_opts_powerpc64le_linux = -platform linux-g++ -xplatform bytz-linux-g++
$(package)_config_opts_riscv64_linux = -platform linux-g++ -xplatform bytz-linux-g++
$(package)_config_opts_s390x_linux = -platform linux-g++ -xplatform bytz-linux-g++

$(package)_config_opts_mingw32 = -no-opengl
$(package)_config_opts_mingw32 += -no-dbus
$(package)_config_opts_mingw32 += -xplatform win32-g++
$(package)_config_opts_mingw32 += "QMAKE_CFLAGS = '$($(package)_cflags)-I/home/ckti/.guix-profile/include $($(package)_cppflags)'"
$(package)_config_opts_mingw32 += "QMAKE_CXXFLAGS = '$($(package)_cflags) -I/home/ckti/.guix-profile/include $($(package)_cppflags)'"
...
# bytz-linux-g++, replace instances of linux-arm-gnueabi with $(host). This
...
define $(package)_preprocess_cmds
  ...
  cp -r qtbase/mkspecs/linux-arm-gnueabi-g++ qtbase/mkspecs/bytz-linux-g++ && \
  sed -i.old "s/arm-linux-gnueabi-/$(host)-/g" qtbase/mkspecs/bytz-linux-g++/qmake.conf && \
  echo "!host_build: QMAKE_CFLAGS     += $($(package)_cflags) -I$(host_prefix)/include/freetype2 $($(package)_cppflags)" >> qtbase/mkspecs/common/gcc-base.conf && \
  echo "!host_build: QMAKE_CXXFLAGS   += $($(package)_cxxflags) -I$(host_prefix)/include/freetype2 $($(package)_cppflags)" >> qtbase/mkspecs/common/gcc-base.conf && \
