...
define $(package)_preprocess_cmds
  ...
  echo "!host_build: QMAKE_CFLAGS     += $($(package)_cflags) -I$(host_prefix)/include $($(package)_cppflags)" >> qtbase/mkspecs/common/gcc-base.conf && \
  echo "!host_build: QMAKE_CXXFLAGS   += $($(package)_cxxflags) -I$(host_prefix)/include $($(package)_cppflags)" >> qtbase/mkspecs/common/gcc-base.conf && \
  echo "!host_build: QMAKE_LFLAGS     += $($(package)_ldflags) -L$(host_prefix)/lib"  >> qtbase/mkspecs/common/gcc-base.conf && \
