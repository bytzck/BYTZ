/* src/config/bytz-config.h.  Generated from bytz-config.h.in by configure.  */
/* src/config/bytz-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BYTZ_CONFIG_H

#define BYTZ_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Bytz Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Bytz Core"
...
#define PACKAGE_BUGREPORT "https://github.com/bytzcurrency/bytz/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Bytz Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bytz Core 0.17.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bytz"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://bytz.gg/"
